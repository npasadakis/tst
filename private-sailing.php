...
$pageTitle = t('meta.private_title');
?>

    <!-- Page Header -->
    <header class="page-header">
        <div class="container">
            <h1><?= t('trips.private.title') ?></h1>
            <p><?= t('trips.private.short_desc') ?></p>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= langUrl('index.php') ?>"><?= t('nav.home') ?></a></li>
                    <li class="breadcrumb-item active"><?= t('nav.private_sailing') ?></li>
                </ol>
            </nav>
        </div>
    </header>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="trip-featured-image mb-4">
                        <img src="<?= getPlaceholderImage(900, 500, 'Private+Sailing+Charter') ?>" alt="<?= t('trips.private.title') ?>" class="img-fluid rounded-4">
                    </div>

                    <!-- Description -->
                    <div class="trip-description mb-5">
                        <h2><?= t('trips.private.title') ?></h2>
                        <p class="lead"><?= t('trips.private.full_desc') ?></p>
                    </div>
                    ...
                    <div class="trip-highlights mb-5">
                        ...
                        <ul class="highlights-list">
                            <?php foreach (tArray('trips.private.highlights') as $highlight): ?>
                                <li>
                    ...
                    <div class="trip-gallery">
                        ...
                        <div class="gallery-grid">
                            <?php
                            $galleryImages = getGalleryImages('private', 6);
                            foreach ($galleryImages as $image): ?>
                                <a href="<?= $image['src'] ?>" class="gallery-item glightbox" data-gallery="private-gallery">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="book-sidebar">
                        ...
                        <a href="<?= langUrl('booking.php?trip=private') ?>" class="book-btn-large">
                            <?= t('common.book_now') ?>
                        </a>
