...
$pageTitle = t('meta.full_day_title');
?>

    <!-- Page Header -->
    <header class="page-header">
        <div class="container">
            <h1><?= t('trips.full_day.title') ?></h1>
            <p><?= t('trips.full_day.short_desc') ?></p>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= langUrl('index.php') ?>"><?= t('nav.home') ?></a></li>
                    <li class="breadcrumb-item active"><?= t('nav.full_day') ?></li>
                </ol>
            </nav>
        </div>
    </header>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="trip-description mb-5">
                        <h2><?= t('trips.full_day.title') ?></h2>
                        <p class="lead"><?= t('trips.full_day.full_desc') ?></p>
                    </div>
                    ...
                    <div class="trip-highlights mb-5">
                        ...
                        <ul class="highlights-list">
                            <?php foreach (tArray('trips.full_day.highlights') as $highlight): ?>
                                <li>
                    ...
                    <div class="trip-gallery">
                        ...
                        <div class="gallery-grid">
                            <?php
                            $galleryImages = getGalleryImages('full_day', 6);
                            foreach ($galleryImages as $image): ?>
                                <a href="<?= $image['src'] ?>" class="gallery-item glightbox" data-gallery="fullday-gallery">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="book-sidebar">
                        ...
                        <a href="<?= langUrl('booking.php?trip=full_day') ?>" class="book-btn-large">
                            <?= t('common.book_now') ?>
                        </a>
